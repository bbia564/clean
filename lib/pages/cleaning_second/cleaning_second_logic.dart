...
import 'package:cleaning_plan/pages/cleaning_first/cleaning_first_logic.dart';
...
class CleaningSecondLogic extends GetxController {
  ...
  cleanCleaningData() async {
    Get.dialog(AlertDialog(
      ...
      actions: [
        ...
        TextButton(
          onPressed: () async {
            await dbCleaning.cleanCleaningData();
  ...
  aboutCleaningPrivacy(BuildContext context) async {
...
If you have any questions or concerns about our privacy policy, please contact us via email.
  ...
  aboutCleaningUS(BuildContext context) async {
    ...
    showAboutDialog(
      ...
      children: [
        const Text("""We can record the cleaning schedule for you"""),
      ],
      context: context,
    );
  }
